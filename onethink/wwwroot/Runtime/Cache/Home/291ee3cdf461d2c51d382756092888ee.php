...
<?php foreach($zu as $z):?>
                        <div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                <img src="<?php echo ($z['img']); ?>" alt="..."  >
                                <div class="caption">
                                    <h4><?php echo ($z['title']); ?></h4>
                                    <p class="zushouInfo"><?php echo ($z['content']); ?></p>
                                    <p class="text-danger"><?php if($z['price_unit']==1){echo $z['price'].'元/月';}else{echo $z['price'].'万元';}?></p>
                                    <p><a class="btn btn-danger zushouBtn" href="<?php echo U('Wechat/info?id='.$z['id']);?>">详细信息</a> </p>
                                </div>
                            </div>
                        </div>
<?php endforeach;?>
                ...
                <div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-md-4">
                            <div class="thumbnail">
                                <img src="<?php echo ($c['img']); ?>" alt="..."  >
                                <div class="caption">
                                    <h4><?php echo ($c['title']); ?></h4>
                                    <p class="zushouInfo"><?php echo ($c['content']); ?></p>
                                    <p class="text-danger"><?php if($c['price_unit']==1){echo $c['price'].'元/月';}else{echo $c['price'].'万元';}?></p>
                                    <p><a class="btn btn-danger zushouBtn" href="<?php echo U('Wechat/info?id='.$c['id']);?>">详细信息</a> </p>
                                </div>
                            </div>
                        </div>
                        <?php endforeach;?>
