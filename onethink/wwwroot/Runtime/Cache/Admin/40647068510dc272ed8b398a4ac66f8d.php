...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" name="stop_time" class="text time" value="<?php echo ($info['stop_time']); ?>" placeholder="请选择时间">                    </div>
        </div>
        ...
        <div class="controls">
            ...
            <input type="hidden" name="img" id="cover_id_<?php echo ($field["name"]); ?>"/>
        ...
        <script type="text/javascript">
            ...
            function uploadPicture<?php echo ($field["name"]); ?>(file, data){
                ...
                var src = '';
                if(data.status){
                    $("#cover_id_<?php echo ($field["name"]); ?>").val(data.url || '' + data.path);
    ...
    <script type="text/javascript">
        ...
        $(function(){
            $('.upload-img-box').html('<img src="<?php echo ($info['img']); ?>"/>');
            $('#cover_id_').val("<?php echo ($info['img']); ?>");
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo U('Property/add');?>');
    </script>
