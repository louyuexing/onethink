    ...
    <div class="container-fluid">
       <?php foreach($info as $row):?>
        <div class="row noticeList">
            ...
            <div class="col-xs-10">
                <p class="title"><a href="<?php echo U('Wechat/activeinfo?id='.$row['id']);?>"><?php echo ($row['title']); ?></a></p>
...
<script type="text/javascript">
   ...
   $('#more').click(function(){
          page++;
       $.post('?s=/Wechat/Wechat/active.html',{'page':page},function(e){
           var html='';
          ...
          $(e).each(function(i,v){
              ...
              html+='<div class="row noticeList"><div class="col-xs-2"><img class="noticeImg" src='+v.img+' width="90px" height="90px" alt="图片丢失"/> </div> <div class="col-xs-10"> <p class="title"><a href="?s=/Wechat/Wechat/activeinfo/id/'+v.id+'.html">'+v.title+'</a></p> <p class="intro">'+v.description+'</p> <p class="info">浏览:'+v.view+' <span class="pull-right">'+create_time+'</span> </p> </div> </div>';
          });
           $(html).appendTo('#amore');
       },'json')
