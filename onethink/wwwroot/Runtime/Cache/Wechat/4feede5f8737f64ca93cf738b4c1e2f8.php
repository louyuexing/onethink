            ...
            <div class="nav-collapse collapse pull-right">
                <?php if(is_login()): else: ?>
                    <ul class="nav" style="margin-right:900px">
                        <li>
                            <a href="<?php echo U('Wechat/index');?>"><u>主页</u></a>
                        </li>
                    </ul>
                    <ul class="nav" style="margin-right:0">
                        <li>
                            <a href="<?php echo U('Wechat/user_login');?>">登录</a>
                        </li>
                        <li>
                            <a href="<?php echo U('Wechat/user_register');?>" style="padding-left:0;padding-right:0">注册</a>
                        </li>
                    </ul><?php endif; ?>
            </div>
        </div>
...
<section>
	<div class="span12">
        <form class="login-form" action="<?php echo U('Wechat/user_login');?>" method="post">
