...
<!--导航结束-->
    ...
    <div class="container-fluid">
        ...
        <div class="noticeDetailInfo">创建时间：<?php echo (time_format($info[0]['create_time'])); ?></div>
        <br/>
        <div class="noticeDetailInfo">内容：<?php echo ($info[0]['description']); ?></div>
        <u><h3><a href="javascript:void(0)">报名参加</a></h3></u>"
...
<script type="text/javascript">
    $('h3').click(function(){
        ...
        $.post('?s=/Wechat/Wechat/addactive.html',{'document':document},function(e){
            if(e==3){
                if(confirm("该活动登录后才能参与")){
                    window.location.href="?s=/Wechat/Wechat/user_login.html"
                };
            }
            if(e==1){
               alert("报名成功等待后台确定");
