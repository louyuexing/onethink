...
<div class="container-fluid">
    <div class="indexImg row">
        <img src="/Public/Home/Wechat/image/index.jpg" width="100%"/>
    </div>
    <div class="serviceList text-center">
        <div class="container">
            <div class="row">
                <div class="col-xs-4">
                    <a href="<?php echo U('Wechat/Wechat/notice');?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo U('Wechat/online');?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo U('Wechat/Wechat/sale');?>">
                ...
                <div class="col-xs-4">
                    <a href="<?php echo U('Wechat/Wechat/active');?>">
...
<script src="/Public/Wechat/Wechat/jquery-1.11.2.min.js"></script>
<!-- Include all compiled plugins (below), or include individual files as needed -->
<script src="/Public/Wechat/Wechat/bootstrap/js/bootstrap.min.js"></script>
</body>
</html>